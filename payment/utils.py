...
from xendit.apis import PayoutApi, InvoiceApi
...
def create_payment_invoice(reference_id, amount,payment_type, customer_email, description="Payment for service"):
