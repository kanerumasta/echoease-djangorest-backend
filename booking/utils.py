...
#         description = f'Your booking for an event on {booking.event_date} with {booking.artist.get_full_name()} has been confirmed.'
...
#         description = f'Your booking for an event on {booking.event_date} with {booking.artist.get_full_name()} has been rejected.'
